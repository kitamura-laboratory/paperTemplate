...
\documentclass[senkouka,sadoku]{nitkagawathesis}%特論（専攻科2年）日本語用，予備審査
%\documentclass[senkouka]{nitkagawathesis}%特論（専攻科2年）日本語用，最終審査
...
%%%%% 副査教員名 %%%%%
\firstreviewer{高専 次郎 准教授}% 1つ引数をとる (役職まで含めて書く)
\secondreviewer{高専 花子 准教授}% 1つ引数をとる (役職まで含めて書く)
